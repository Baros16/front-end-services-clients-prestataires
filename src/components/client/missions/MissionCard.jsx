...
import { formatDateShort, buildMissionDisplayTitle } from '../../../utils/formatters';

export function MissionCard({ mission }) {
  const navigate = useNavigate();
  const dateAffichee = mission.completedAt ?? mission.startedAt;
  const displayTitle = buildMissionDisplayTitle(mission);
    ...
    <Card>
      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-start gap-3 min-w-0">
          <Avatar initial={displayTitle.charAt(0)} size="sm" />
